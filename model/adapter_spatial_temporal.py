...
if __name__ == "__main__":
    ...
    for dim, channel in zip(dims, channels):
        ...
        # 模拟输入数据
        # hidden_states = torch.randn(8, 320, 64, 64)
        # num_frames = 1
        # timestep = torch.tensor([1.0])
        # encoder_hidden_states = torch.randn(1, 2048)  # cross-attn 参考维度 2048

        # summary(
        #     adapter,
        #     input_data=(hidden_states, num_frames, timestep, encoder_hidden_states),
